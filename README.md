...
└──────────┬───────────┘
          ...
          HTTP
           ▼
 ┌──────────────────────┐
 │ Servlets              │ │ │ HomePage │ │ FindPathServlet │ │ ExploreRelations │ │ Servlet │ └──────────┬───────────┘ │ ▼ ┌──────────────────────┐ │ GraphService │ │ │ │ Cypher Queries │ │ Result Processing │ └──────────┬───────────┘ │ │ Neo4j Java Driver ▼ ┌──────────────────────┐ │ CognoDB │ │ Graph Database │ └──────────────────────┘\`
...
│       ├── COGNODB GRAPH.png
│       ├── explorerelations1.png
│       ├── explorerelations2.png
│       ├── homepage.png
│       └── pathfinder1.png
├── src/
│   └── main/
...
│       │               ├── CypherToJson.java
│       │               ├── ExploreRelationsServlet.java
│       │               ├── FindPathServlet.java
│       │               ├── GraphService.java
│       │               └── HomePage.java
│       ├── resources/
│       │   └── cypher/
│       │       ├── queries/
│       │       │   ├── ExploreRelations.cypher
│       │       │   ├── FindPath.cypher
│       │       │   └── LoadAllNodes.cypher
│       │       └── seed/
│       │           ├── READMESEED.md
...
![Home Page](/tree/master/docs/screenshots/homepage.png)
...
![Path Finder Page](/tree/master/docs/screenshots/findpath.png)
...
![Explore Relations 1](/tree/master/docs/screenshots/explorerelations1.png)

![Explore Relations 2](/tree/master/docs/screenshots/explorerelations2.png)
